          ...
          <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} spacing={6}>
            {news.map((article) => (
              <Box
                ...
                textDecoration="none"
                _hover={{
                  transform: article.url ? 'translateY(-4px)' : 'none',
                  boxShadow: article.url ? '0 8px 30px rgba(0, 217, 255, 0.3)' : 'none',
                  borderColor: article.url ? 'brand.400' : 'rgba(0, 217, 255, 0.2)',
                }}
              >
                {article.imageUrl && (
                  <Image
